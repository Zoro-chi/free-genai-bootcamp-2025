...
import { HiMenu, HiX, HiOutlineBookOpen, HiHome, HiInformationCircle } from 'react-icons/hi';
...
const Header = () => {
  ...
  const styles = {
    ...
    nav: {
      ...
      backgroundColor: theme === 'dark' ? '#1a1a1a' : '#fff',
      borderTop: isMobile ? `1px solid ${theme === 'dark' ? '#333' : '#d1c4a8'}` : 'none',
      boxShadow: isMobile ? (theme === 'dark' ? '0 4px 8px rgba(0,0,0,0.3)' : '0 4px 8px rgba(0,0,0,0.1)') : 'none',
