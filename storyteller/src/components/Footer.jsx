  ...
  return (
    <footer style={footerStyles.container}>
      <div style={footerStyles.column}>
        ...
        <a href="/read?book=Genesis&chapter=1" style={footerStyles.link}>
          Old Testament
        </a>
        <a href="/read?book=Matthew&chapter=1" style={footerStyles.link}>
          New Testament
        </a> */}
        ...
        <div className="flex space-x-4">
          <Link
            href="/terms"
            className="text-bible-ink hover:text-bible-royal text-xs"
          >
            Terms of Service
          </Link>
          <Link
